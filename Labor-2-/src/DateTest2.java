...
public class DateTest2
{
	...
	public void testDayOfWeek1471789() throws Exception
	{
		...
		assertTrue("TUESDAY".equalsIgnoreCase(testDate.getWeekday().toString()));
	}
	...
	public void testDayOfWeek9111989() throws Exception
	{
		...
		System.out.println(testDate.getWeekday().toString());
		assertTrue("THURSDAY".equalsIgnoreCase(testDate.getWeekday().toString()));
	} 
	...
	{
		Date compare = new Date(4, 6, 1988);
		assertEquals(compare, testee);
	}
	
	@Test
	public void testEqualsNull()
	{
		assertTrue(!testee.equals(null));
	}
